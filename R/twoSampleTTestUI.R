  ...
  tagList(
    ...
    column(12,style = " background-color: white; border-radius: 5px; ",
           ...
           column(width=12,
                  br(),
           HTML(paste0(
             "Enter your null hypothesis H",tags$sub("0")," for the difference in population means \u03BC",tags$sub("2")," - \u03BC",tags$sub("1")," here:"
           )),
           br(),
           br(),
           numericInput(ns("nullDiff"),HTML(paste0("H",tags$sub("0"),": \u03BC",tags$sub("2")," - \u03BC",tags$sub("1")," ="
           )),value=0),
           br()
           ),
    ...
    column(12, style = " background-color: white; border-radius: 5px; ",
          ...
          column(width=12,
            h3("Normality"),
           "Use the following plots to assess the assumption of normality. Use the buttons next to 'Learn:' on the right for information about other assumptions.",
           br(),
           br(),
          ),
    ...
    column(12, style = "background-color: white; border-radius: 5px; ",
       ...
       br(),
           ...
           br(),
       column(12,
       h4(textOutput(ns("ttestTableTitle"))),
       #br(),
...
twoSampleTTestServer <- function(id) {
  ...
  output$downloadData<-downloadHandler(filename=function(){
    paste0(tempdir(), "/", "2SampTTestOut.xlsx")
  },
  content=function(file){
    ...
    #    addStyle(wb,sheet,style=boldStyle,rows=c(1,3,nrow(ttest1a)+4+2),cols=6)
      ...
      observeEvent(input[["sheet"]], {
        if(read_xlsx(input[["tTestData"]][["datapath"]], sheet = input[["sheet"]])[1,1] != "2-Sample T-Test"){
          sendSweetAlert(
            session,
            title = "Incorrect File",
            text = "Not a 2-Sample T-Test Analysis File. Please upload an analysis file compatible with the 2-Sample T-Test Tool.",
            type = "error",
            btn_colors="#5f5f62"
          )
        }else{
