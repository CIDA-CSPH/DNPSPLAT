...
1. **What is my [outcome variable](https://www.ncbi.nlm.nih.gov/books/NBK557882/)?**
...
- Using [McNemar's test]{.test-mcnemar} on unpaired categorical data
...
|:-------------|:-------|:------------------|:-----------------|
| Continuous | Independent | Normal | [**2-Sample T-Test**](#sample-t-test-independent-samples){.test-2sample-t} ([Helpful video](https://www.khanacademy.org/math/ap-statistics/xfb5d8e68:inference-quantitative-means/two-sample-t-test-means/v/two-sample-t-test-for-difference-of-means)) |
| Continuous | Independent | Non-normal/Skewed | [**Wilcoxon Rank-Sum Test**](#wilcoxon-rank-sum-test-mann-whitney-u){.test-wilcox-rank} ([Helpful video](https://www.youtube.com/watch?v=AM87jjnNt8U)) |
| Continuous | Paired/Matched | Normal | [**Paired T-Test**](#paired-t-test){.test-paired-t} ([Helpful video](https://www.khanacademy.org/math/ap-statistics/xfb5d8e68:inference-quantitative-means/two-sample-t-test-means/v/example-of-hypotheses-for-paired-and-2-sample-t-tests)) |
| Continuous | Paired/Matched | Non-normal/Skewed | [**Wilcoxon Signed-Rank Test**](#wilcoxon-signed-rank-test){.test-wilcox-signed} ([Helpful video](https://www.youtube.com/watch?v=4XdhxQ3THS0)) |
| Categorical | Independent | Large sample (all cells ≥ 5) | [**Chi-Squared Test**](#chi-squared-test){.test-chisq} ([Helpful video](https://www.khanacademy.org/math/ap-statistics/chi-square-tests/chi-square-goodness-fit/v/chi-square-statistic)) |
| Categorical | Independent | Small sample (any cell < 5) | [**Fisher's Exact Test**](#fishers-exact-test){.test-fisher} ([Helpful video](https://www.youtube.com/watch?v=W_wqly6Fr-o)) |
| Categorical | Paired/Matched | Any | [**McNemar's Test**](#mcnemars-test){.test-mcnemar} ([Helpful video](https://www.youtube.com/watch?v=lbkdvDTXVQM)) |
